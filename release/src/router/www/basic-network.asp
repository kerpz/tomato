...
//	<% nvram("dhcp_lease,dhcp_num,dhcp_start,dhcpd_startip,dhcpd_endip,l2tp_server_ip,lan_gateway,lan_ipaddr,lan_netmask,lan_proto,lan_state,lan_desc,lan_invert,mtu_enable,ppp_demand,ppp_idletime,pppoe_lei,pppoe_lef,ppp_passwd,ppp_redialperiod,ppp_service,ppp_username,ppp_custom,pptp_server_ip,pptp_dhcp,wl_security_mode,wan_dns,dnscrypt_proxy,dnscrypt_port,dnscrypt_cmd,wan_gateway,wan_ipaddr,wan_mtu,wan_netmask,wan_proto,wan_wins,wl_wds_enable,wl_channel,wl_closed,wl_crypto,wl_key,wl_key1,wl_key2,wl_key3,wl_key4,wl_lazywds,wl_mode,wl_net_mode,wl_passphrase,wl_radio,wl_radius_ipaddr,wl_radius_port,wl_ssid,wl_wds,wl_wep_bit,wl_wpa_gtk_rekey,wl_wpa_psk,wl_radius_key,wl_auth,wl_hwaddr,wan_islan,t_features,wl_nbw_cap,wl_nctrlsb,wl_nband,wl_phytype,lan_ifname,lan_stp,lan1_ifname,lan1_ipaddr,lan1_netmask,lan1_proto,lan1_stp,dhcp1_start,dhcp1_num,dhcp1_lease,dhcpd1_startip,dhcpd1_endip,lan2_ifname,lan2_ipaddr,lan2_netmask,lan2_proto,lan2_stp,dhcp2_start,dhcp2_num,dhcp2_lease,dhcpd2_startip,dhcpd2_endip,lan3_ifname,lan3_ipaddr,lan3_netmask,lan3_proto,lan3_stp,dhcp3_start,dhcp3_num,dhcp3_lease,dhcpd3_startip,dhcpd3_endip,ppp_mlppp,modem_ipaddr,modem_pin,modem_dev,modem_init,modem_apn,cstats_enable,ppp3g_en,ppp3g_dev,ppp3g_init,ppp3g_apn,ppp3g_username,ppp3g_passwd,ppp3g_keepalive,ppp3g_custom,ppp3g_demand,ppp3g_redialperiod,ppp3g_route,ppp3g_ipup,ppp3g_ipdown"); %>
...
//		if(wl_ifaces[uidx][0].indexOf('.') < 0) {
	...
	var ppp3g_route = E('_ppp3g_route').value;
	switch (ppp3g_route) {
	case '1':
	case '2':
		vis._ppp3g_ipup = 0;
	...
	vis._ppp3g_redialperiod = vis._ppp3g_demand;
...
createFieldTable('', [
	...
	{ title: 'Connect Mode', name: 'ppp3g_demand', type: 'select', options: [['1', 'Manual'],['0', 'Keep Alive']],
	...
	{ title: 'Route', name: 'ppp3g_route', type: 'select', options: [['0','Custom'],['1','Default'],['2','Facebook']], value: nvram.ppp3g_route },
