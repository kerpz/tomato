...
extern void asp_ppp3g_status(int argc, char **argv);
extern void asp_ppp3g_up(int argc, char **argv);
extern void asp_ppp3g_uptime(int argc, char **argv);
extern void asp_ppp3g_ops(int argc, char **argv);
extern void asp_ppp3g_sq(int argc, char **argv);
extern void asp_ppp3g_ip(int argc, char **argv);
extern void asp_ppp3g_gw(int argc, char **argv);
extern void asp_ppp3g_dns(int argc, char **argv);
